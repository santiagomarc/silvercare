<x-dashboard-layout sc>
    ...
    <main id="main-content" class="sc-app-main">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-12 py-6 space-y-6">
            ...
            <form method="POST" action="{{ route('caregiver.medications.update', $medication) }}" id="medicationForm" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="sc-card p-6">
                    ...
                    <div class="sc-field">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $medication->name) }}" class="sc-input" placeholder="e.g. Lisinopril, Metformin" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="sc-field mb-0">
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="dosage" id="dosage" value="{{ old('dosage', $medication->dosage) }}" class="sc-input flex-1 min-w-0" placeholder="e.g. 10, 500" required>
                        ...
                        <div class="sc-field mb-0">
                            ...
                            <input type="text" name="start_date" id="start_date" value="{{ old('start_date', $medication->start_date?->format('Y-m-d')) }}" class="sc-input cursor-pointer" placeholder="Select date..." aria-label="Start Date">
                        </div>

                        <!-- End Date -->
                        <div class="sc-field mb-0">
                            <label for="end_date" class="sc-label">End Date <span class="sc-label-opt">(Optional)</span></label>
                            <input type="text" name="end_date" id="end_date" value="{{ old('end_date', $medication->end_date?->format('Y-m-d')) }}" class="sc-input cursor-pointer" placeholder="Select date..." aria-label="End Date">
                        </div>
                    </div>
                </div>
                ...
                <div class="sc-card p-6">
                    ...
                    <div class="sc-field {{ $scheduleType === 'specific_date' ? '' : 'hidden' }}" id="specificDatesSection">
                        ...
                        <div id="specificDateContainer" data-initial-dates='@json(old('specific_dates', $medication->specificScheduleDates()))' class="flex flex-wrap gap-2 mb-3"></div>
                    ...
                    <div class="sc-field mb-0">
                        ...
                        <div id="timeSlotContainer" data-initial-times='@json(old('times_of_day', $medication->times_of_day ?? []))' class="flex flex-wrap gap-2 mb-3"></div>
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                ...
                <div class="sc-card p-6">
                    ...
                    <div class="sc-field">
                        ...
                        <textarea name="instructions" id="instructions" rows="3" class="sc-textarea" placeholder="e.g. Take with food, do not crush, avoid grapefruit...">{{ old('instructions', $medication->instructions) }}</textarea>
                    </div>
                    ...
                    <div class="sc-card-quiet p-5 rounded-[var(--sc-radius)] border border-[var(--sc-line)]">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="sc-check m-0 p-0 min-h-touch flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="track_inventory" id="track_inventory" value="1" {{ old('track_inventory', $medication->track_inventory) ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sc-field mb-0">
                                ...
                                <input type="number" name="current_stock" id="current_stock" value="{{ old('current_stock', $medication->current_stock) }}" min="0" class="sc-input text-sm" placeholder="e.g. 30">
                            </div>
                            <div class="sc-field mb-0">
                                <label for="low_stock_threshold" class="sc-label text-xs">Low Stock Alert</label>
                                <input type="number" name="low_stock_threshold" id="low_stock_threshold" value="{{ old('low_stock_threshold', $medication->low_stock_threshold ?? 5) }}" min="0" class="sc-input text-sm">
                            </div>
                        </div>
                    </div>
                </div>
